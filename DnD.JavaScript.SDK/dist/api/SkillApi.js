...
class SkillApi {
    static GetAsync(token, url) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const uri = `${url}/${constants_1.skillEndpoint}`;
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("SkillApi.GetAsync().Exception", error));
                ;
            }
        });
    }
    static GetByIdAsync(token, url, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const uri = `${url}/${constants_1.skillEndpoint}/${id}`;
                const response = yield httpService_1.default.getAsync(token, uri);
                if (response.ok) {
                    const data = yield response.json();
                    if (data === null) {
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("SkillApi.GetByIdAsync().Exception", error));
                ;
            }
        });
    }
}
exports.default = SkillApi;
