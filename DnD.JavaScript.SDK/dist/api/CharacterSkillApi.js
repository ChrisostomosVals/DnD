    ...
    static CreateAsync(token, url, request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("CharacterSkillApi.InsertItemAsync().Exception", error));
                ;
            }
        });
    }
    static UpdateAsync(token, url, request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("CharacterSkillApi.UpdateItemAsync().Exception", error));
                ;
            }
        });
    }
