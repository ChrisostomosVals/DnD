...
class WorldMiscApi {
    static GetAsync(token, url) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const uri = `${url}/${constants_1.worldMiscEndpoint}`;
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("WorldMiscApi.GetAsync().Exception", error));
                ;
            }
        });
    }
    static GetByIdAsync(token, url, id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const uri = `${url}/${constants_1.worldMiscEndpoint}/${id}`;
                const response = yield httpService_1.default.getAsync(token, uri);
                if (response.ok) {
                    const data = yield response.json();
                    if (data === null) {
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("WorldMiscApi.GetByIdAsync().Exception", error));
                ;
            }
        });
    }
    static GetByDependIdAsync(token, url, dependId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const uri = `${url}/${constants_1.worldMiscEndpoint}/${dependId}/depend`;
                const response = yield httpService_1.default.getAsync(token, uri);
                if (response.ok) {
                    const data = yield response.json();
                    if (data === null) {
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("WorldMiscApi.GetByDependIdAsync().Exception", error));
                ;
            }
        });
    }
    static CreateAsync(token, url, request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("WorldMiscApi.CreateAsync().Exception", error));
                ;
            }
        });
    }
    static UpdateAsync(token, url, request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return new ApiResponseModel_1.default(null, ErrorResponseModel_1.default.NewError("WorldMiscApi.UpdateAsync().Exception", error));
                ;
            }
        });
    }
}
exports.default = WorldMiscApi;
//# sourceMappingURL=WorldMiscApi.js.map